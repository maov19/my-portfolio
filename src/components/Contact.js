...
const Contact = () => {
  ...
  return (
    <div className='d-flex flex-column align-items-center form-container' style={{ height: '93vh', width: '100vw', backgroundColor: '#22333B', color: 'white', paddingTop: '10vh'}}>
      ...
      <form ref={form} onSubmit={sendEmail} className='fs-6 d-flex flex-column justify-content-center align-items-center gap-2'>
