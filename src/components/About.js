...
const About = () => {
  return (
    <>
    <div class="box"><b></b>
    <section className='vh-100 vw-100 d-flex flex-column justify-content-start align-items-center text-center fw-bold about' id='about'>
      ...
      <div className='about-content'>
        ...
        <a href="https://drive.google.com/file/d/1MYHBs4kdq5WNMwbLbpJeeE-PMclamAYb/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className='text-white'>
            <button className='my-4 fw-bold p-2 see-projects-btn'>Check my resume</button>
        </a>
      </div>
    </section>
    </div>
